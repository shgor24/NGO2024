 ...
 */
public class TaBortHandlaggare extends javax.swing.JFrame {
    ...
    /**
     * Creates new form TaBortHandlaggare
     */
    public TaBortHandlaggare(InfDB idb, String pid, String aid) {
        this.idb = idb;
        this.pid = pid;
        this.aid = aid;
        initComponents();
    ...
    private void hamtaProjektetsHandlaggare() {
        try {
            ...
            String sqlFraga = "select anstalld.fornamn, anstalld.efternamn, anstalld.aid from anstalld join handlaggare on anstalld.aid = handlaggare.aid where anstalld.aid in (select aid from ans_proj where pid = " + pid + ") and anstalld.aid != " + aid;
            ...
            //Skapar en ny DefaultListModel
            DefaultListModel<String> lista = new DefaultListModel<>();

            /*
             *Hämtar handläggarnas för- och efternamn och sätter ihop de till en String, 
             *samt lägger till namnen tillsammans med aid till listan
             */
            ...
            //Sätter listans model till den som fylldes med information
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TaBortHandlaggare.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
