...
public class LaggTillHandlaggare extends javax.swing.JFrame {
    ...
    public LaggTillHandlaggare(InfDB idb, String pid) {
        this.idb = idb;
        this.pid = pid;
        initComponents();
    ...
    {
        try{
        //En sql-fråga som hämtar alla handläggares för- och efternamn
        String sqlFraga = ("select fornamn, efternamn, aid from anstalld where aid in (select aid from handlaggare)");
        ...
        for(HashMap<String, String> rad : resultatLista)
        {
            ...
            handlaggareLista.put(aid, namnLista);
            
        }
        
        DefaultListModel<String> lista = new DefaultListModel<>();
        
        for(String aid : handlaggareLista.keySet())
        {
            ArrayList<String> handlaggareNamn = handlaggareLista.get(aid);
