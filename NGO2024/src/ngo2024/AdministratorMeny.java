...
public class AdministratorMeny extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbValdProjekt.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Lägg till projekt", "Ta bort projekt", "Se/Ändra uppgifter om ett projekt" }));
...
//metod för rullistan anställd i adminsitratör menyn
...
//metod för rullistan projekt i administratör menyn 
    private void cbValdProjektActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbValdProjektActionPerformed
        ...
        } else if (detValdaAlternativet.equals("Se/Ändra uppgifter om ett projekt" + "")) {
            new AndraUppgifterProjektSelect(idb).setVisible(true);
        }

    }//GEN-LAST:event_cbValdProjektActionPerformed
    //Metod för rullistan avdelning i administratör menyn 
    ...
    // metod för rullistan Partner i administratör menyn
    ...
    // metod för rullistan land i administratör menyn 
