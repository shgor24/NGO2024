 ...
 */
public class laggtillpartners2 extends javax.swing.JFrame {

    private InfDB idb;
    private String pid;
    private String aid;
    /**
     * Creates new form laggtillpartners2
     */
    public laggtillpartners2(InfDB idb, String pid, String aid) {
        this.idb = idb;
        this.pid = pid;
        this.aid = aid;
        initComponents();
    ...
    private void hamtaAllaPartners() {
        try {
            String sqlFraga = "SELECT partner.namn, partner.kontaktperson, partner.pid " +
                              "FROM partner " +
                              "WHERE partner.pid NOT IN (SELECT partner_pid FROM projekt_partner WHERE pid = " + pid + ")";
            ...
            for (HashMap<String, String> rad : resultatLista) {
                ...
                // Här skapas ArrayListan som lagrar för- och efternamn för varje hämtad partner
            ...
            this.listapartners.setModel(lista);
    ...
    private void listener() {
        listapartners.addListSelectionListener(new ListSelectionListener() {
            ...
            // När användaren har valt en partner i listan kommer detta att köras, tack vare valueChanged() metoden
            public void valueChanged(ListSelectionEvent e) {
                ...
                if (!e.getValueIsAdjusting()) {
                    ...
                    if (valtIndex != -1) {
                        // Hämtar partnernamnet som valdes i listan
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(laggtillpartners2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new laggtillpartners2().setVisible(true);
            }
        });
    }
